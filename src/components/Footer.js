        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="#" className="p-2 rounded-lg bg-gray-800 hover:bg-gray-700 transition-colors" aria-label="X (Twitter)">
                {/* X Logo */}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/add-idea" className="hover:text-white transition-colors">Submit Idea</Link></li>
